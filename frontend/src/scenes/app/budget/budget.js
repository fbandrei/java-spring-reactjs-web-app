      ...
      <div className={"col-10"}>
        <div className={"row"}>
          <div className={"col-12"}>
            <HeaderBudget
              toBeBudget={this.state.toBeBudget}
              setToBeBudget={this.setToBeBudget.bind(this)}
        ...
        <div className={"row"}>
          <div className={"col-12"}>
            <ActionsBudget
              setNewSubcategory={this.setNewSubcategory.bind(this)}
              setNewCategory={this.setNewCategory.bind(this)}
            />
          </div>
        </div>
        <div className={"row"}>
          <div className={"col-12"}>
            <CenterBudget
              newSubcategory={this.state.newSubcategoryCreated}
              newCategory={this.state.newCategoryCreated}
              setToBeBudget={this.setToBeBudget.bind(this)}
              toBeBudget={this.state.toBeBudget}
