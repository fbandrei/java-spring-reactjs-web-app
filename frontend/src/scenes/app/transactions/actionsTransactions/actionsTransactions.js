        ...
        return(
            <div className={"container actions"}>
                <div className={"actions-buttons"}>
                        <span>
                            <Button type="default" icon="plus-circle-o" onClick={this.toggleModalTransaction.bind(this)}>Add Transaction</Button>
                ...
                <ModalTransaction reRender={this.reRender.bind(this)} toggleModalTransaction={this.toggleModalTransaction.bind(this)} modal={this.state.modalTransaction}/>
                <ModalTemplate reRenderTemplate={this.reRenderTemplate.bind(this)} toggleModalTemplate={this.toggleModalTemplate.bind(this)} modal={this.state.modalTemplate}/>
