        ...
        return(
            <div>
                <footer className={"jumbotron text-center"}>
                    ...
                    <hr/>
                    <button onClick={() => this.getCompanyAge()} className={"btn btn-primary"}>Find out the company age!</button>
                    <hr/>
                    <input type={"text"} value={this.state.helloWorld}
                        onChange={(event) => this.onHandleChange(event)}/>
                    <button onClick={this.onChangeHello.bind(this)}>Change the world!</button>
                </footer>
            </div>
